"""TELEOP セッションでは idle 復帰をしない (HAND_TEACH では従来通り発火)。"""
...
@pytest.mark.asyncio
async def test_teleop_does_not_call_move_to_idle(tmp_path):
...
@pytest.mark.asyncio
async def test_hand_teach_still_calls_move_to_idle(tmp_path):
